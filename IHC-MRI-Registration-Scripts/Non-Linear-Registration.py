...
class NonlinearRegistration:
    ...
    def nonlinear_registration_UI(self):
        ...
        # Set up grid with space for controls - include spacing parameters here
        ...
        radio_ax = fig.add_axes([0.05, 0.02, 0.15, 0.08])
        ...
        button_ax = fig.add_axes([0.25, 0.02, 0.3, 0.08])
        ...
        reset_ax = fig.add_axes([0.6, 0.02, 0.15, 0.08])
        ...
        # Don't use tight_layout - spacing is already set in GridSpec
